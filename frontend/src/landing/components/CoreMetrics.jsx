...
const CoreMetrics = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: 'url(/images/landing/frame1.png)',
    ...
    >
      <div className="feature-card-header">
        <h3 className="feature-card-title">Real-Time Core Metrics</h3>
      </div>

      <div className="feature-card-footer">
        <p className="feature-card-description">
          Monitor your agent's decision pipeline and real-time execution parameters in a streamlined interface.
        </p>
      </div>
